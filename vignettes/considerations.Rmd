...
`rgee` is very similar to the [Earth Engine Python API](https://pypi.org/project/earthengine-api/), with the exception of **three** particular cases. Each of these are explained in-depth below.
...
The code before is perfectly valid but `rgee` will produce an error. This could be solved by adding the function **ee_utils_pyfunc** to the code. Let's see:
