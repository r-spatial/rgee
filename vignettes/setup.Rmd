...
The `ee_check()` function will help you for checking sanity of your `rgee` instalation. Additionally you can separately check the rgee dependencies with the following functions:
