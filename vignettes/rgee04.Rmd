...
An EEtk is a 100-character text string (OAuth2 credential) stored on your local system that is used to identify and authenticate GEE users (See Figure below). In other words, it will help you to connect the EE Web REST API with their local system.
...
3. Set the **_credentials_** file in the path *~/.config/earthengine/* inside the deployed virtual machine.
...
Load the rgeeApp project and modify the .Renviron file according to their personal token user information. Go to https://www.shinyapps.io/admin/#/tokens.
