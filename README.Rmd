...
structure has been inspired in [tensorflow for R](https://github.com/rstudio/tensorflow/).
...
the syntax between `rgee` and the two client libraries.
...
**Quite similar, isn't it?**. However there are a few additional small changes you will need to make to use Google Earth Engine in R seamlessly. Please check the [consideration section]() before you start coding!
...
```
`rgee` depends on [sf](https://github.com/r-spatial/sf). Therefore, it is necessary
to install their external libraries, run as follows according your operating system. 
