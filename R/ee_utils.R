...
#'
#' sakfile <- "/home/rgee_dev/sak_file.json"
#' ee_utils_sak_validate(sakfile_l)
#'
#' }
#' @export
ee_utils_sak_validate <- function(sakfile, quiet = FALSE) {
  ee_check_packages(
  ...
  tryCatch(
    expr = {
      ...
      stop("Oops, An error arised when reading a GCS object")
    }
  )
