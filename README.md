...
structure has been inspired in [tensorflow for
...
compare the syntax between `rgee` and the two client libraries.
...
changes you will need to make to use Google Earth Engine in R
seamlessly. Please check the [consideration section]() before you start
coding\!
